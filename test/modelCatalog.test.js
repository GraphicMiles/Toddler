...
import { MODEL_CATALOG, getModelBySha256, validateCatalog } from '../src/models/catalog.js';
...
assert.equal(getModelBySha256(MODEL_CATALOG[0].sha256)?.id, MODEL_CATALOG[0].id);
