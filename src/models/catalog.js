...
export const MODEL_CATALOG = Object.freeze([
  { id: 'smollm-135m-q3', name: 'SmolLM 135M Test', file: 'smollm-135m-q3.gguf', size: 94, sizeUnit: 'MB', task: 'smoke-test', description: 'Under-100 MB offline runtime smoke test; not coding-capable.', downloadUrl: 'https://huggingface.co/QuantFactory/SmolLM-135M-Instruct-GGUF/resolve/main/SmolLM-135M-Instruct.Q3_K_M.gguf?download=true', sha256: null, runtime: 'llama.cpp', android: true, minRam: 2 },
